...
if ($grade==1) {$strSQL = "SELECT ci_title AS label, ci1 AS rightText, ci_type FROM ci_rpt";}
else if($grade=="0") {$strSQL = "SELECT ci_title AS label, ci0 AS rightText, ci_type FROM ci_rpt";}
else {$strSQL = "SELECT ci_title AS label, survey AS rightText, ci_type FROM ci_rpt";}
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");

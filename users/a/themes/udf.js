...
// highlight row ของ clist ที่มี value = cval
function row_light(clist, cval) {
	var s = 0;
	var return_obj = [];
	require([
 	"dojo/ready",
...
// Function สำหรับ Save to mySQL and Run ccode ////////////////////
...
// แสดง Switch ใน List Parameter : ชื่อ List, ชื่อ switch, ข้อความ label, ค่าแสดงเปิด/ปิด 0/1, ตัวแปร1, ตัวแปร 2

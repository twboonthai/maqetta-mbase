...
///////////////////////////////
		...
		on(main_menu_list, "click", function() {
			...
			if (lcselected == "7") {main_menu.performTransition("pcu", 1, "slide", null);}
		});
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////
//// CUP     /////////////////
...
///////////////////////////////
		...
		on(person_title, "click", function() {
			back("back_person", "person", "main_menu", "person_list");
		});
...
///////////////////////////////
		...
		on(a_score_title, "click", function() {
			...
			if (issave == true) {
				// Save adl ////////////////////////////////////////////////
				var adl_str = adl1.toString() + adl2.toString() + adl3.toString() + adl4.toString() + adl5.toString() + adl6.toString() + adl7.toString() + adl8.toString() + adl9.toString() + adl10.toString();
				mysave("adl_addupd.php?auto_id=" + lnauto + "&cid=" + lccid + "&staff_cid=" + lcstaffcid + "&adl=" + adl_str, "list('adl_list', 'adl_cid.php?cid=' + lccid)");
...
///////////////////////////////
		...
		on(b_detail_title, "click", function() {
			...
			if (issave == true) {
				...
				brain_score();
				row_light("b_score_list", cbrn.replace("brn", ""));

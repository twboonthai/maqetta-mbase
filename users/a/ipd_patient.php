...
$strSQL1 = "CREATE TEMPORARY TABLE ipd AS SELECT a.bed_no, g.nickname AS diagnosis, c.hn, a.visit_id, c.reg_datetime, 
	...
	WHERE DAY(a.dsc_dt) = 0 AND a.is_cancel = 0 AND a.ward_no = '".$ward."' AND TRIM(a.bed_no) > '' 
...
END AS bed_name, adm_id, home_adr, ampur, province, zipcode, telephone FROM ipd GROUP BY adm_id ORDER BY bed_no";

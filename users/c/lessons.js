...
///////////////////////////////
		...
		var list_add = view1_list.store.newItem({label: "ทดสอบ view1", header: true, value : "0"});
		var list_add = view1_list.store.newItem({label: "เมนู 1", rightText: ">",  value : "1"});
		var list_add = view1_list.store.newItem({label: "เมนู 2", rightText: ">",  value : "2"});
		var list_add = view1_list.store.newItem({label: "เมนู 3", rightText: ">",  value : "3"});
		//////////////////
		//// Function ////
		//////////////////
...
///////////////////////////////
		...
		var new_store = new ifws({data:{items:[]}});
		view2_list.setStore(new_store);
		//list("view2_list", "staff_name.php");
		//////////////////
		//// Function ////////////////////////////////////////////

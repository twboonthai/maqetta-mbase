...
///////////////////////////////
		...
		//////////////////
		function pobj() {
			var patient = php2obj("cid_search.php?cid=" + lcuser);
			if (patient.fname !== undefined) {
				lccid = patient.cid;
				...
				spinner.stop();
				clearList("stemi_visits");
				dialog("แจ้งข้อผิดพลาด", "alert", "x", "c", "ไม่พบรหัสประชาชน " + lcuser + " ในฐานข้อมูล ...");
			}
		}
